...
|-----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | **Piero Velarde Luyo** <br> **Avance 1:** Analicé el planteamiento del problema y profundicé mis conocimientos informáticos para integrar en la solución los segmentos de usuarios adecuados, basándome en los requerimientos del software. <br> **Avance 2:** La redacción y elaboración del capítulo 4 me permitió actualizar mis conocimientos en arquitectura de software. Gracias a esto, pude estructurar la solución con mayor claridad y tomar decisiones técnicas fundamentadas que impulsan mi desarrollo profesional.<br>  **Joaquin Carranza** <br> **Avance 1:** Reconocí que el aprendizaje permanente en técnicas de Needfinding es clave para entender problemas reales. Al usar mapas de empatía en BibFlip, comprendí que debo actualizar constantemente mis herramientas de análisis para capturar requerimientos cambiantes y asegurar que el software aporte valor real al usuario. <br> **Avance 2:** Identifiqué la necesidad de estudiar continuamente estándares de arquitectura como el Modelo C4 y ADR. Esta etapa me enseñó que el desempeño profesional exige curiosidad técnica para estructurar sistemas sólidos, documentados y lo suficientemente flexibles para evolucionar ante futuras innovaciones.<br> **TP:** La implementación de microservicios y el uso de Scrum reafirmaron que el aprendizaje autónomo es el motor del desarrollo moderno. Enfrentar retos de despliegue y pruebas me demostró que la excelencia profesional depende de la formación técnica constante para resolver problemas complejos de forma eficiente. <br> | **Avance 1:** Como equipo, revisamos los conceptos clave del proyecto para definir el problema y desarrollar la solución. Al identificar áreas de mejora en la arquitectura de software, actualizamos nuestros conocimientos para aplicar las mejores prácticas. Esto nos permitió diseñar un software más robusto y escalable. <br> **Avance 2:** Investigamos y aplicamos conceptos de arquitectura de software para estructurar nuestra propuesta. Esto nos permitió definir los elementos solicitados e identificar qué otros conocimientos eran necesarios para diseñar una arquitectura sólida.  | **Avance 1:** Como equipo, revisamos los conceptos clave del proyecto para definir el problema y desarrollar la solución. Al identificar áreas de mejora en la arquitectura de software, actualizamos nuestros conocimientos para aplicar las mejores prácticas. Esto nos permitió diseñar un software más robusto y escalable. <br> **Avance 2:** Investigamos y aplicamos conceptos de arquitectura de software para estructurar nuestra propuesta. Esto nos permitió definir los elementos solicitados e identificar qué otros conocimientos eran necesarios para diseñar una arquitectura sólida.  **David Rengifo Lozano** <br> **Avance 1:** Investigué y definí los requerimientos técnicos iniciales y las historias de usuario (User Stories), asegurando que la transición entre la problemática detectada y la especificación funcional fuera técnica y viable para una arquitectura orientada a servicios. <br> **Avance 2:** Me encargué del diseño detallado de las vistas C4 y UML para los módulos de Gestión de Reservas e Integración IoT (sección 4.3.2.6). Esto me permitió profundizar en la representación visual de sistemas distribuidos y la sincronización de estados entre dispositivos físicos y la nube. <br> **TP:** Lideré la definición y ejecución de las Suites de Prueba y Patrones Generales (sección 5.1). Implementé pruebas de carga de contexto, verifiqué el comportamiento de los patrones CQRS y Assembler en el backend, y establecí la estrategia de manejo global de excepciones. | **Avance 1:** El equipo logró una base sólida de requerimientos que permitió proyectar una arquitectura escalable. Identificamos que la precisión en tiempo real era el factor crítico de éxito. <br> **Avance 2:** La aplicación de la metodología ADD nos permitió tomar decisiones técnicas fundamentadas en atributos de calidad, logrando un diseño que soporta fallos de red sin pérdida de datos.                         |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.  | **Piero Velarde Luyo** <br> **Avance 1:** Me familiaricé con el perfil de los usuarios y el personal técnico para integrarme por completo al proyecto, impulsando propuestas de organización y reuniones de trabajo. <br> **Avance 2:** Liderar el equipo me hizo notar que el aprendizaje continuo es vital en el desarrollo de software. Por ello, investigué conceptos técnicos clave para respaldar nuestras decisiones arquitectónicas y orientar la solución de manera efectiva.<br> **Joaquin Carranza** <br> **Avance 1:** En esta etapa, comprendí que el éxito de un software depende de la actualización constante en técnicas de UX Research. Al emplear Needfinding y User Personas para BibFlip, reconocí que el aprendizaje continuo en metodologías de descubrimiento es vital para identificar necesidades reales y evitar el desarrollo de soluciones obsoletas que no aporten valor al usuario final. <br> **Avance 2:** Durante el diseño arquitectónico, identifiqué la necesidad de dominar estándares modernos como el Modelo C4 y el registro de decisiones técnicas (ADR). Este avance me demostró que el desempeño profesional exige un estudio permanente de patrones de diseño, asegurando que la estructura de la solución sea escalable, documentada y capaz de adaptarse a futuras evoluciones tecnológicas.<br> **TP:** En la fase de implementación, la adopción del paradigma de microservicios y el marco de trabajo Scrum reafirmaron que la autoformación técnica es indispensable. Al gestionar el despliegue y las pruebas de forma iterativa, consolidé el hábito del aprendizaje autónomo como la única vía para dominar tecnologías distribuidas y metodologías de alta eficiencia en el desarrollo de software.. <br>                                          | **Avance 1:** En esta etapa, el equipo colaboró para desarrollar la solución y repasó los conceptos previos para fundamentar nuestras herramientas. Además, investigamos nuevos temas para entender mejor el problema, lo que nos permitió definir los requerimientos y las historias de usuario de forma coherente y precisa. <br> **Avance 2:** Continuaremos investigando y definiendo los conceptos técnicos necesarios para diagramar nuestra arquitectura. Así, garantizaremos la satisfacción de los requerimientos de los interesados y daremos inicio a la primera iteración del diseño arquitectónico guiado por atributos. | **David Rengifo Lozano** <br> **Avance 1:** Comprendí que el desarrollo de software moderno requiere dominar técnicas de elicitación que conecten el negocio con la tecnología. Refiné el Product Backlog priorizando la viabilidad técnica de los sensores IoT. <br> **Avance 2:** Identifiqué la importancia de dominar arquitecturas híbridas (Edge-Cloud). El diseño de la iteración 2 me enseñó a gestionar la latencia y el rendimiento en sistemas que dependen de telemetría en tiempo real. <br> **TP:** La implementación de la suite de pruebas me demostró que la excelencia profesional no solo radica en escribir código, sino en garantizar su estabilidad mediante patrones de diseño probados y una cobertura de testing rigurosa en entornos Spring Boot. | **Avance 1:** El proceso de Needfinding nos enseñó que las soluciones obsoletas surgen por falta de actualización en UX Research. Como equipo, nos comprometimos a usar herramientas modernas de mapeo de escenarios. <br> **Avance 2:** Concluimos que para diseñar una arquitectura sólida es vital el estudio constante de estándares como el Modelo C4, lo que garantiza una documentación clara para todos los stakeholders. |
